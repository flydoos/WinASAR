...
01. 支持单选或多选文件、文件夹压缩成 .Asar 格式文件

02. 支持把 .Asar 格式文件解压到指定目录

03. 支持往已存在的 .Asar 文件中追加其他文件、删除文件、以及重命名

04. 支持测试 .Asar 文件是否存在错误

05. 支持 WinASAR 内置文件查看器，用于查看大文件，且支持文本搜索以及文件编码切换

06. 支持轻量级 Windows 资源管理功能，可实现文件、文件夹的复制（可自动创建不重名副本）、删除操作支持放入系统回收站、支持重命名等

07. 支持文件夹 “..” 返回上一层目录

08. 支持 Windows 目录下查找文件，以及支持 .Asar 内部查找文件
